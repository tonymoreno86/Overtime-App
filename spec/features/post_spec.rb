...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      other_user = User.create(first_name: "Non", last_name: "Authorized", email: "nonauth@test.com", password: "benzc230", password_confirmation: "benzc230")
  ...
  describe 'edit' do
    before do
      @edit_user = User.create(first_name: "Tony", last_name: "M", email: "test2@test2.com", password: "benzc230", password_confirmation: "benzc230")
